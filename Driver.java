...
public class Driver {
    public static void main(String[] args) {
        ...
        MotelRoom room1 = new Deluxe();
        room1 = new Spa(room1);
        room1 = new Refill(room1);
        room1 = new FoodBar(room1);
        room1 = new Shower(room1);

        System.out.println(room1.getDescription()+ " Costs: $" + currencyFormatter.format(room1.cost()) );
